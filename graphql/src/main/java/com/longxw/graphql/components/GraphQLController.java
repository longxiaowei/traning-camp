...
public class GraphQLController {
    ...
    public Object graphqlPOST(
        ...
        if (MediaType.APPLICATION_JSON_VALUE.equals(contentType)) {
            ...
            GraphQLRequestBody request = o.readValue(body, GraphQLRequestBody.class);
    ...
    private Map<String, Object> convertVariablesJson(String jsonMap) throws IOException {
        if (jsonMap == null) {
            return Collections.emptyMap();
        }
        return new ObjectMapper().readValue(jsonMap, Map.class);
    }
